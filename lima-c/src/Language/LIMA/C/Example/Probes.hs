{- |
Module: Probes
Description: Example usage of probes in LIMA
Copyright: (c) 2015 Chris Hodapp

This demonstrates the usage of LIMA's probe functionality. In this case, it
simply uses @printf@ to log a probe's value. Most POSIX systems should be able
to build and run the generated C code.

-}
module Language.LIMA.C.Example.Probes where
