...
--
-- Definitions for LIMA expressions, variables, and types
...
-- make typed LIMA expressions an instance of Floating
...
-- the scope of a 'cond' or 'mux' that tests for @0@ (because LIMA generates
