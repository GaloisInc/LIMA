...
--
-- Definitions for SLIM expressions, variables, and types
...
-- make typed SLIM expressions an instance of Floating
...
-- the scope of a 'cond' or 'mux' that tests for @0@ (because SLIM generates
